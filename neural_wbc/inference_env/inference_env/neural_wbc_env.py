...
class NeuralWBCEnv(EnvironmentWrapper):
    ...
    def _compute_observations(self):
        ...
        self.extras["data"] = {
            ...
            "state": {
                "body_pos": current_body_state.body_pos_extend.cpu().numpy(),
                "joint_pos": current_body_state.joint_pos.cpu().numpy(),
                "root_pos": current_body_state.root_pos.cpu().numpy(),
                "root_rot": current_body_state.root_rot.cpu().numpy(),
                "root_lin_vel": current_body_state.root_lin_vel.cpu().numpy(),
            },
            "ground_truth": {
                "body_pos": ref_motion_state.body_pos_extend.cpu().numpy(),
                "joint_pos": ref_motion_state.joint_pos.cpu().numpy(),
                "root_pos": ref_motion_state.root_pos.cpu().numpy(),
                "root_rot": ref_motion_state.root_rot.cpu().numpy(),
                "root_lin_vel": ref_motion_state.root_lin_vel.cpu().numpy(),
            },
