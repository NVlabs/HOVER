...
class NeuralWBCEnv(DirectRLEnv):
    ...
    def _get_observations(self) -> dict:
        ...
        self.extras["data"] = {
            ...
            "state": {
                "body_pos": body_state.body_pos_extend.cpu().numpy(),
                "joint_pos": body_state.joint_pos.cpu().numpy(),
                "root_pos": body_state.root_pos.cpu().numpy(),
                "root_lin_vel": body_state.root_lin_vel.cpu().numpy(),
                "root_rot": body_state.root_rot.cpu().numpy(),
            },
            "ground_truth": {
